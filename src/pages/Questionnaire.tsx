        ...
        <CardContent>
          <Box display="flex" flexDirection="column" marginTop="1em">
            {chatHistory.map((chatMessage, index) => (
              <Fragment key={index}>
                 <Box display="flex" justifyContent={chatMessage.isUser ? "flex-end" : "flex-start"} style={{ padding: "0.5em .5em 0 0.5em",marginTop: ".5em",
maxWidth: "75%", borderWidth: "2px", backgroundColor: "yellow",borderStyle: "solid", borderColor: 'red', borderRadius: "20px", width: 'fit-content', marginLeft: 'auto'}}>
                  <Typography
                    variant="body1"
                    className={`${classes.chatMessage} ${chatMessage.isUser ? "user" : "bot"}`}
                ...
                {chatMessage.message ? (
                           <Box display="flex" justifyContent={chatMessage.isUser ? "flex-end" : "flex-start"}  style={{ padding: "0.5em .5em 0 0.5em", marginTop:".5em",
                           maxWidth: "75%", borderWidth: "2px", backgroundColor: "red",borderStyle: "solid", borderColor: 'yellow', borderRadius: "20px", width: 'fit-content', marginRight: 'auto'}}>
                                             <Typography
                                               variant="body1"
                                               className={`${classes.chatMessage} ${chatMessage.isUser ? "user" : "bot"}`}
                  ...
                  <Box display="flex" justifyContent={chatMessage.isUser ? "flex-end" : "flex-start"} marginBottom="0.5em" style={{ padding: "0.5em .5em 0 0.5em", margin:".5em 0 .5rm 0",
                  maxWidth: "75%", borderRadius: "20px", width: 'fit-content', marginRight: 'auto'}}>
                                    <Typography
                                      variant="body1"
                                      className={`${classes.chatMessage} ${chatMessage.isUser ? "user" : "bot"}`}
                                      style={{ textAlign: 'left', wordWrap: 'break-word' }}
